...
def lifetime_to_temperature_lin32(x):
    temperature = 0.0079065187*(x**4) + 0.0366814649*(x**3) - 5.5270715294*(x**2) + 72.1314211424*x - 251.8643173184
    return temperature
...
def lifetime_to_temperature_Hela(x):
    temperature = 0.0504967104200471*(x**6) - 2.26638446940322*(x**5) + 42.0594063916615*(x**4) - 412.714691229774*(x**3) + 2256.40968069216*(x**2) - 6509.58277053094*x + 7755.40769741854
    return temperature

def lifetime_to_temperature_GPMV(x):
    temperature = 0.445947735*(x**3) - 8.150522878*(x**2) + 50.34433998*x - 75.19820968
    return temperature
